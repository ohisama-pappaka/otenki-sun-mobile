...
def home():
    ...
    week_api = f"https://api.open-meteo.com/v1/forecast?{lat}&{lon}&hourly=temperature_2m,precipitation&daily=weathercode,temperature_2m_max,temperature_2m_min,precipitation_sum,precipitation_hours&timezone=Asia%2FTokyo"
    ...
    def daily_weather():
        ...
        for time_cnt in range(0, 48, 6):
            ...
            output_weather = main_data["hourly"][time_cnt]["weather"][0][
                "icon"
            ]  # 　天気情報
    ...
    def weekly_weather():
        ...
        for time_cnt in range(0, 6):
            ...
            week_weather = main_data["daily"][time_cnt]["weather"][0]["icon"]
